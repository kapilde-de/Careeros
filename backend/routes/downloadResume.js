...
const {
  ...
  WidthType, VerticalAlign, convertInchesToTwip
} = require('docx');
...
// ════════════════════════════════════════════════════════════════════════════
// CLASSIC — single column, navy header bar, ruled section headings
// ════════════════════════════════════════════════════════════════════════════
function buildClassic(r, t) {
  const children = [];

  // Name block with bottom border
...
// ════════════════════════════════════════════════════════════════════════════
// MODERN — teal accent, shaded section headers, clean layout
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
// EXECUTIVE — formal, double-ruled name, all-caps bold headings
// ════════════════════════════════════════════════════════════════════════════
function buildExecutive(r, t) {
  const children = [];

  // Centered name with top+bottom double border
  children.push(new Paragraph({
  ...
  const section = (title) => [
    new Paragraph({
      children: [new TextRun({ text: title.toUpperCase(), bold: true, size: 22, color: t.accent, font: t.font, allCaps: true })],
      border: {
        bottom: { style: BorderStyle.DOUBLE, size: 4, color: t.accent },
      },
...
// ════════════════════════════════════════════════════════════════════════════
// MINIMAL — ultra clean, hairline rules, light grey headings
// ════════════════════════════════════════════════════════════════════════════
...
router.post('/', async (req, res) => {
  try {
    ...
    switch (format) {
      ...
      default:           children = buildClassic(resume, t);   break;  // apex + classic
    }
